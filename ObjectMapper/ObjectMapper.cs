...
namespace DanielCirket.ObjectMapper
{
    ...
    public static class ObjectMapper
    {
        ...
        //    object defaulPropertyValue = null;

        //    T objectToFill = instance;

        //    if (objectToFill == null)
        //        objectToFill = new T();

        //    // Get properties for type
        //    List<PropertyInfo> objProperties = GetPropertyInfo(objectToFill.GetType());
        ...
        //        defaulPropertyValue = Null.SetNull(propertyInfo);

        //        if (propertyInfo.CanWrite)
        //        {
        //            #region Check if value should be overwritten, if not, skip this property. - TODO, MAKE THIS LESS CRAP.
        ...
        //                var defaultValue = GetDefault(propertyType);
        ...
        //            if (ordinals[i] != -1)
        //            {
        //                var value = datareader.GetValue(ordinals[i]);
        //                valueDataType = value.GetType();

        //                if (value == null || value == DBNull.Value)
        //                {
        //                    // Set to 'null' value
        //                    propertyInfo.SetValue(objectToFill, defaulPropertyValue, null);
        //                }
        //                else if (propertyType.Equals(valueDataType))
        //                {
        //                    // Same type, just set as is.
        //                    propertyInfo.SetValue(objectToFill, value, null);
        //                }
        //                else
        //                {
        ...
        //                        {
        //                            // If numeric
        //                            propertyInfo.SetValue(objectToFill, Enum.ToObject(propertyType, Convert.ToInt32(value)), null);
        //                        }
        //                        else if (value is string)
        //                        {
        //                            // string - try to parse to enum? Is this worth doing, 
        //                            //          performance will more than likely be crap
        //                        }
        //                        else
        //                        {
        //                            // other type
        //                            propertyInfo.SetValue(objectToFill, Enum.ToObject(propertyType, value), null);
        //                        }
        ...
        //                    {
        //                        // Guid
        //                        propertyInfo.SetValue(objectToFill, Convert.ChangeType(new Guid(value.ToString()), propertyType, null));
        //                    }
        //                    else if (value is IConvertible)
        //                    {
        //                        // Changetype.
        //                        propertyInfo.SetValue(objectToFill, ChangeType(value, propertyType), null);
        //                    }
        //                    else
        //                    {
        //                        // try explicit.
